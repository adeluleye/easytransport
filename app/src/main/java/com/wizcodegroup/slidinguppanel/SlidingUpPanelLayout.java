package com.wizcodegroup.slidinguppanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
	 ...
	 */
	private static final int[] DEFAULT_ATTRS = new int[] { android.R.attr.layout_gravity };
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		if (childCount > 2) {
			...
			Log.e(TAG, "onMeasure: SlideUpPanelLayout must has 2 childs views");
		}
