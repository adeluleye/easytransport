...
public class MyAdapter extends RecyclerView.Adapter<MyAdapter.ViewHolder> {
    ...
    private String mListStrDrawerTitles[]; // String Array to store the passed titles Value from MainActivity.java
    //private int mIcons[];       // Int Array to store the passed icons resource value from MainActivity.java
    //private TypedArray mListStrDrawerIcons;
    private int mListStrDrawerIcons[];
    ...
    MyAdapter(String Titles[],int Icons[], Context passedContext){ // MyAdapter Constructor with titles and icons parameter
        ...
        mListStrDrawerTitles = Titles;                //have seen earlier
        mListStrDrawerIcons = Icons;
        //name = Name;
        //email = Email;
    ...
    public void onBindViewHolder(MyAdapter.ViewHolder holder, int position) {
        if(holder.Holderid ==1) {                              // as the list view is going to be called after the header view so we decrement the
            ...
            holder.textView.setText(mListStrDrawerTitles[position - 1]); // Setting the Text with the array of our Titles
            holder.imageView.setImageResource(mListStrDrawerIcons[position -1]);// Settimg the image with array of our icons
            //holder.imageView.setImageResource(mListStrDrawerIcons);// Settimg the image with array of our icons
        }
        else{
    ...
    public int getItemCount() {
        return mListStrDrawerTitles.length+1; // the number of items in the list will be +1 the titles including the header view.
    }
